...
Then install and start up Tailwind
```pwsh
npm install

# Continuosly compiles Tailwind into CSS on file changes - for development 
npm run watch

# Compiles Tailwind into CSS once - for production
npm run build
```

Start up Hugo by running
```pwsh
...
3. Considering changing font of page
4. Fetch songs from youtube/spotify playlist
5. Update "listening" card to have a more fun/interactive UI